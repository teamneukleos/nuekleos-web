...
*/
-- DropForeignKey
ALTER TABLE "claims" DROP CONSTRAINT "claims_permission_name_fkey";

-- DropForeignKey
ALTER TABLE "claims" DROP CONSTRAINT "claims_role_name_fkey";

-- DropForeignKey
ALTER TABLE "claims" DROP CONSTRAINT "claims_user_id_fkey";

-- DropForeignKey
ALTER TABLE "permission_role" DROP CONSTRAINT "permission_role_permission_name_fkey";

-- DropForeignKey
ALTER TABLE "permission_role" DROP CONSTRAINT "permission_role_role_name_fkey";
