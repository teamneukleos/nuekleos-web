...
import { createProduct } from "@/lib/api-calls";
...
const NewProductForm = () => {
  ...
  const queryClient = useQueryClient();
            ...
            const form = useForm<TFormData>({ resolver: zodResolver(productSchema) });

            const onSubmit = async (input: TFormData) => {
              const { data, error, validationErrors } = await createProduct(input);
              ...
              if (data) {
                ...
                toast({
                  variant: "destructive",
                  title: "Error",
                  description: "Failed to create proppduct.",
                });
              }
