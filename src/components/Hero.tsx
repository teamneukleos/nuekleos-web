...
const Hero = () => {
  const blogPosts = [
    {
      ...
      description: "Participants and MSMEs from the Fashion Future Program brought the stage to life with stunning, handmade designs...",
      image: "/stories/runway-showcase.png",
      link: "/stories/runway-showcase",
    },
    {
      title: "Reflect, Realign, Reimagine",
      description: "Co-Creating the Future of Work and Enterprise in Africa through innovative partnerships...",
      image: "/stories/reflect-realign.jpg",
      link: "/stories/reflect-realign",
    },
    {
      title: "Empowering Artisans",
      description: "Through Skills Development programs, we're building the next generation of creative entrepreneurs...",
      image: "/stories/artisan-skills.jpg",
  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-start text-white">
      ...
      {/* Floating Blog Card with Navigation */}
