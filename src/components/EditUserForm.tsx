...
import { z } from "zod";
import { editUser } from "@/lib/api-calls";
import { useQueryClient } from "@tanstack/react-query";
import { useToast } from "@/components/ui/use-toast";
import { useState, useEffect } from "react";
import { Eye, EyeOff } from "lucide-react";
import { IUser } from "@/lib/models/models";
import { QUERY_KEY } from "@/lib/rbac";

export default function EditUserForm ({ user, onSuccess }: { user: IUser; onSuccess?: () => void }) {
  type UserFormInput = z.infer<typeof updateUserSchema>;
