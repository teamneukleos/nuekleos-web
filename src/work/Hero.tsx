    ...
    <section className="relative w-full h-[100vh] flex items-center justify-start">
      ...
      <div className="relative z-10 max-w-3xl px-6 md:px-12 pt-40 md:pt-64 text-white">
        ...
        <p className="mt-6 text-sm md:text-sm font-light leading-relaxed">
          We are connectors of systems, people and opportunities.<br /> We build a thriving
          creative economy by enhancing efficiency,<br /> productivity, and global competitiveness
          of local creative <br /> ecosystems. Rooted in Africa, ready for the world.
        </p>
      </div>
